...
export default function Menu() {
    ...
    const getTabClass = (tab: ActiveTabs) => {
        ...
        return `py-2 px-2 rounded-[35px] flex items-center justify-between gap-1 cursor-pointer ${
            isTabActive ? "bg-black text-white" : "text-black"
        }`;
    };

    return (
        <div className="flex items-center my-3 fixed bottom-0 h-[80px] w-screen left-0 right-0 justify-center text-white">
